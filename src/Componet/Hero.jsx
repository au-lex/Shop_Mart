...
export const Hero = () => {
  return (
    <section className="relative pt-[4rem] px-4 bg-gradient-to-r from-[#fcf9de] to[#f3e9cc]"> {/* Updated gradient background */}
      ...
      <div className="hero w-full borr rounded-sm shadow-sm">
