  ...
  return (
    ...
    <h1 className="text-2xl font-extrabold text-blue==-500">
      E<span className="text-yellow-500">_</span>Shoppy
        ...
        <div>
          ...
          <ul className="space-y-2 text-[12px]">
            ...
            <li><a href="#" className="hover:text-yellow-500 transition">Categories</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-[12px]">
            ...
            <li><a href="#" className="hover:text-yellow-500 transition">Shipping</a></li>
            <li><a href="#" className="hover:text-yellow-500 transition">Returns</a></li>
            <li><a href="#" className="hover:text-yellow-500 transition">Order Status</a></li>
            <li><a href="#" className="hover:text-yellow-500 transition">Payment Options</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-[12px] mb-4">Subscribe to our newsletter for updates and exclusive offers.</p>
          <form className="flex">
            <input
              type="email"
            ...
            <button
              type="submit"
              className="bg-yellow-500 hover:bg-yellow-600 px-4 py-2 rounded-r-md transition"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="mt-8 text-center text-sm">
        <p>&copy; {new Date().getFullYear()} E_Shoppy. All rights reserved.</p>
      </div>
    </div>
  </footer>
